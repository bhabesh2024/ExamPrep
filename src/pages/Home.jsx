...
import { PlayCircle, Activity, Brain, Zap, Languages, GraduationCap, Twitter, Briefcase, Code, Bot } from 'lucide-react';
  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-[#0a0a0a] text-slate-100 font-sans overflow-x-hidden selection:bg-[#0d59f2] selection:text-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up" style={{ animationDelay: '0.3s', opacity: 0 }}>
              ...
              <button 
                ...
                className="glass-card hover:bg-[#161616]/80 text-white text-lg font-medium py-4 px-10 rounded-full transition-all flex items-center justify-center gap-2 border border-[#27272a] w-full sm:w-auto"
              >
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="glass-card rounded-[3rem] p-10 md:p-16 text-center border border-white/5 relative overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 relative z-10">
                <button 
                  onClick={() => navigate('/test')} 
                  className="cta-glow bg-[#0d59f2] hover:bg-blue-600 text-white text-lg font-bold py-4 px-12 rounded-full transition-all transform hover:-translate-y-1 shadow-lg shadow-[#0d59f2]/30 w-full sm:w-auto"
                >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
            ...
            <div className="col-span-2 lg:col-span-2">
              ...
              <div className="flex gap-4">
                ...
                <button className="text-slate-400 hover:text-white transition-colors"><Briefcase className="w-5 h-5" /></button>
                <button className="text-slate-400 hover:text-white transition-colors"><Code className="w-5 h-5" /></button>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li><button className="hover:text-[#0d59f2] transition-colors">Features</button></li>
                <li><button onClick={() => navigate('/test')} className="hover:text-[#0d59f2] transition-colors">Exam Library</button></li>
                <li><button className="hover:text-[#0d59f2] transition-colors">Changelog</button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li><button onClick={() => navigate('/about')} className="hover:text-[#0d59f2] transition-colors">About Us</button></li>
                <li><button className="hover:text-[#0d59f2] transition-colors">Blog</button></li>
                <li><button className="hover:text-[#0d59f2] transition-colors">Contact</button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li><button className="hover:text-[#0d59f2] transition-colors">Privacy Policy</button></li>
                <li><button className="hover:text-[#0d59f2] transition-colors">Terms of Service</button></li>
                <li><button className="hover:text-[#0d59f2] transition-colors">Cookie Policy</button></li>
              </ul>
            </div>
      ...
      <div className="fixed bottom-8 right-8 z-50">
        <button className="chatbot-glow group relative flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-violet-600 to-indigo-600 text-white transition-transform hover:scale-105 active:scale-95 cursor-pointer border-none outline-none">
