...
export default function QuizPage() {
  ...
  const dummyOptions = [
    "This is option statement A", 
    "This is option statement B", 
    "This is option statement C", 
    "This is option statement D"
  ];
  ...
  return (
    <div className="bg-[#f5f6f8] dark:bg-[#0f1115] text-slate-900 dark:text-slate-100 font-sans h-screen flex flex-col overflow-hidden selection:bg-[#0d59f2]/30 relative">
      ...
      <div className="flex-1 flex overflow-hidden relative">
          ...
          <div className="absolute inset-0 z-50 bg-[#0f1115]/80 backdrop-blur-md flex flex-col items-center justify-center">
            <div className="bg-[#1a1d24] p-8 rounded-2xl border border-[#282e39] text-center shadow-2xl">
              ...
              <button 
                ...
                className="px-8 py-3 rounded-full bg-[#0d59f2] hover:bg-blue-600 text-white font-bold flex items-center gap-2 mx-auto transition-all"
              >
        ...
        {/* 👇 FIX: LEFT PANEL ko Flex-Col banaya taaki bar fix rahe 👇 */}
        <main className={`flex-1 flex flex-col relative transition-filter ${isPaused ? 'blur-sm' : ''}`}>
              ...
              <div className="bg-[#1a1d24] rounded-xl p-6 border border-[#282e39] shadow-lg">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex gap-2">
                    <button className="p-1.5 hover:bg-[#282e39] rounded-full text-gray-400 hover:text-white transition-colors">
                      <Flag className="w-5 h-5" />
                    </button>
                    <button onClick={handleMarkReview} className="p-1.5 hover:bg-[#282e39] rounded-full text-gray-400 hover:text-white transition-colors">
                ...
                <p className="text-lg md:text-xl font-medium leading-relaxed text-slate-200">
                  This is a placeholder question text for question number {currentQ + 1}. Once you integrate the backend, the real questions will appear here seamlessly without breaking the UI.
                </p>
              </div>
                ...
                {dummyOptions.map((opt, idx) => {
                  ...
                  return (
                    <button 
                      ...
                      // 👇 FIX: Neon glow halka kiya, shadow subtle ki aur text-shadow hataya 👇
          ...
          {/* 👇 FIX: Bottom Action Bar - Always Fixed at the bottom of the left column 👇 */}
