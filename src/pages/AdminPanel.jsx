...
import FlaggedQuestionsView from '../components/admin/views/FlaggedQuestionsView'; // 🔥 Ye file zarur honi chahiye
import useAdminLogic from '../hooks/useAdminLogic';

export default function AdminPanel() {
  const [activeTab, setActiveTab] = useState('questions');
  const adminState = useAdminLogic(); // Backend logic safely imported
