...
import { ArrowLeft, GraduationCap, ListOrdered } from 'lucide-react';

export default function PracticeHeader({ topicId, showResult, isLoadingQuestions, totalQuestions, currentQ, setIsMobilePaletteOpen }) {
